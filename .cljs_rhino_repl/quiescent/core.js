...
return (function (){
var this__35300__auto__ = this;
var _STAR_component_STAR_38355 = quiescent.core._STAR_component_STAR_;
quiescent.core._STAR_component_STAR_ = this__35300__auto__;
...
}finally {quiescent.core._STAR_component_STAR_ = _STAR_component_STAR_38355;
}});
});
...
var this__35300__auto__ = this;
var _STAR_component_STAR_38356 = quiescent.core._STAR_component_STAR_;
quiescent.core._STAR_component_STAR_ = this__35300__auto__;
...
}finally {quiescent.core._STAR_component_STAR_ = _STAR_component_STAR_38356;
}});
;})(basic))
});})(basic))
;
...
return (function (){
var this__35300__auto__ = this;
var _STAR_component_STAR_38357 = quiescent.core._STAR_component_STAR_;
quiescent.core._STAR_component_STAR_ = this__35300__auto__;
...
}finally {quiescent.core._STAR_component_STAR_ = _STAR_component_STAR_38357;
}});
...
return (function (cb){
var this__35300__auto__ = this;
var _STAR_component_STAR_38358 = quiescent.core._STAR_component_STAR_;
quiescent.core._STAR_component_STAR_ = this__35300__auto__;
...
}finally {quiescent.core._STAR_component_STAR_ = _STAR_component_STAR_38358;
}});
...
})),cljs.core.map.call(null,(function (p__38369){
var vec__38370 = p__38369;
var key = cljs.core.nth.call(null,vec__38370,(0),null);
var impl = cljs.core.nth.call(null,vec__38370,(1),null);
var temp__4425__auto__ = quiescent.core.lifecycle_impls.call(null,key);
if(cljs.core.truth_(temp__4425__auto__)){
var impl_map = temp__4425__auto__;
return cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__31709__auto__ = ((function (impl_map,temp__4425__auto__,vec__38370,key,impl){
return (function quiescent$core$build_lifecycle_impls_$_iter__38371(s__38372){
return (new cljs.core.LazySeq(null,((function (impl_map,temp__4425__auto__,vec__38370,key,impl){
return (function (){
var s__38372__$1 = s__38372;
while(true){
var temp__4425__auto____$1 = cljs.core.seq.call(null,s__38372__$1);
if(temp__4425__auto____$1){
var s__38372__$2 = temp__4425__auto____$1;
if(cljs.core.chunked_seq_QMARK_.call(null,s__38372__$2)){
var c__31707__auto__ = cljs.core.chunk_first.call(null,s__38372__$2);
var size__31708__auto__ = cljs.core.count.call(null,c__31707__auto__);
var b__38374 = cljs.core.chunk_buffer.call(null,size__31708__auto__);
if((function (){var i__38373 = (0);
while(true){
if((i__38373 < size__31708__auto__)){
var vec__38377 = cljs.core._nth.call(null,c__31707__auto__,i__38373);
var method = cljs.core.nth.call(null,vec__38377,(0),null);
var impl_ctor = cljs.core.nth.call(null,vec__38377,(1),null);
cljs.core.chunk_append.call(null,b__38374,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [method,impl_ctor.call(null,impl)], null));

var G__38379 = (i__38373 + (1));
i__38373 = G__38379;
continue;
} else {
return true;
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__38374),quiescent$core$build_lifecycle_impls_$_iter__38371.call(null,cljs.core.chunk_rest.call(null,s__38372__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__38374),null);
}
} else {
var vec__38378 = cljs.core.first.call(null,s__38372__$2);
var method = cljs.core.nth.call(null,vec__38378,(0),null);
var impl_ctor = cljs.core.nth.call(null,vec__38378,(1),null);
return cljs.core.cons.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [method,impl_ctor.call(null,impl)], null),quiescent$core$build_lifecycle_impls_$_iter__38371.call(null,cljs.core.rest.call(null,s__38372__$2)));
}
} else {
return null;
}
...
});})(impl_map,temp__4425__auto__,vec__38370,key,impl))
,null,null));
});})(impl_map,temp__4425__auto__,vec__38370,key,impl))
;
return iter__31709__auto__.call(null,impl_map);
})());
} else {
return null;
}
...
var args38380 = [];
var len__31995__auto___38387 = arguments.length;
var i__31996__auto___38388 = (0);
while(true){
if((i__31996__auto___38388 < len__31995__auto___38387)){
args38380.push((arguments[i__31996__auto___38388]));

var G__38389 = (i__31996__auto___38388 + (1));
i__31996__auto___38388 = G__38389;
continue;
} else {
}
break;
...
var this__35300__auto__ = this;
var _STAR_component_STAR_38383 = quiescent.core._STAR_component_STAR_;
quiescent.core._STAR_component_STAR_ = this__35300__auto__;

try{return cljs.core.not_EQ_.call(null,quiescent.core._STAR_component_STAR_.props.value,next_props.value);
}finally {quiescent.core._STAR_component_STAR_ = _STAR_component_STAR_38383;
}}),new cljs.core.Keyword(null,"render","render",-1408033454),(function (){
var this__35300__auto__ = this;
var _STAR_component_STAR_38384 = quiescent.core._STAR_component_STAR_;
quiescent.core._STAR_component_STAR_ = this__35300__auto__;
...
}finally {quiescent.core._STAR_component_STAR_ = _STAR_component_STAR_38384;
...
return (function() { 
var G__38391__delegate = function (value,constant_args){
var props = {};
props.value = value;

props.constants = constant_args;

var temp__4425__auto___38392 = new cljs.core.Keyword(null,"keyfn","keyfn",780060332).cljs$core$IFn$_invoke$arity$1(opts);
if(cljs.core.truth_(temp__4425__auto___38392)){
var keyfn_38393 = temp__4425__auto___38392;
props.key = keyfn_38393.call(null,value);
} else {
}

return React.createElement(react_component,props);
};
var G__38391 = function (value,var_args){
var constant_args = null;
if (arguments.length > 1) {
var G__38394__i = 0, G__38394__a = new Array(arguments.length -  1);
while (G__38394__i < G__38394__a.length) {G__38394__a[G__38394__i] = arguments[G__38394__i + 1]; ++G__38394__i;}
  constant_args = new cljs.core.IndexedSeq(G__38394__a,0);
} 
return G__38391__delegate.call(this,value,constant_args);};
G__38391.cljs$lang$maxFixedArity = 1;
G__38391.cljs$lang$applyTo = (function (arglist__38395){
var value = cljs.core.first(arglist__38395);
var constant_args = cljs.core.rest(arglist__38395);
return G__38391__delegate(value,constant_args);
});
...
var factory_38396 = React.createFactory(React.addons.CSSTransitionGroup);
/**
 ...
 * works.
 */
quiescent.core.CSSTransitionGroup = ((function (factory_38396){
return (function quiescent$core$CSSTransitionGroup(opts,children){
return factory_38396.call(null,cljs.core.clj__GT_js.call(null,cljs.core.assoc.call(null,opts,new cljs.core.Keyword(null,"children","children",-940561982),children)));
});})(factory_38396))
;
var factory_38397 = React.createFactory(React.addons.TransitionGroup);
/**
 ...
 * works.
 */
quiescent.core.TransitionGroup = ((function (factory_38397){
return (function quiescent$core$TransitionGroup(props,children){
return factory_38397.call(null,cljs.core.clj__GT_js.call(null,cljs.core.assoc.call(null,props,new cljs.core.Keyword(null,"children","children",-940561982),children)));
});})(factory_38397))
;
/**
...
var _STAR_component_STAR_38398 = quiescent.core._STAR_component_STAR_;
quiescent.core._STAR_component_STAR_ = this$;

try{return f.call(null,this$.getDOMNode());
}finally {quiescent.core._STAR_component_STAR_ = _STAR_component_STAR_38398;
}} else {
return null;
}
...
if(cljs.core.truth_(temp__4425__auto__)){
var f = temp__4425__auto__;
var _STAR_component_STAR_38399 = quiescent.core._STAR_component_STAR_;
quiescent.core._STAR_component_STAR_ = this$;

try{return f.call(null,this$.getDOMNode());
}finally {quiescent.core._STAR_component_STAR_ = _STAR_component_STAR_38399;
}} else {
return null;
}
...
if(cljs.core.truth_(temp__4425__auto__)){
var f = temp__4425__auto__;
var _STAR_component_STAR_38400 = quiescent.core._STAR_component_STAR_;
quiescent.core._STAR_component_STAR_ = this$;

try{return f.call(null);
}finally {quiescent.core._STAR_component_STAR_ = _STAR_component_STAR_38400;
}} else {
return null;
}
...
if(cljs.core.truth_(temp__4425__auto__)){
var f = temp__4425__auto__;
var _STAR_component_STAR_38401 = quiescent.core._STAR_component_STAR_;
quiescent.core._STAR_component_STAR_ = this$;

try{return f.call(null);
}finally {quiescent.core._STAR_component_STAR_ = _STAR_component_STAR_38401;
}} else {
return null;
}
...
if(cljs.core.truth_(temp__4425__auto__)){
var f = temp__4425__auto__;
var _STAR_component_STAR_38402 = quiescent.core._STAR_component_STAR_;
quiescent.core._STAR_component_STAR_ = this$;

try{return f.call(null,this$.getDOMNode());
}finally {quiescent.core._STAR_component_STAR_ = _STAR_component_STAR_38402;
}} else {
return null;
}
})});
var did_warn_38405 = cljs.core.atom.call(null,false);
/**
 ...
 */
quiescent.core.wrapper = ((function (did_warn_38405){
return (function quiescent$core$wrapper(){
var args__32002__auto__ = [];
var len__31995__auto___38406 = arguments.length;
var i__31996__auto___38407 = (0);
while(true){
if((i__31996__auto___38407 < len__31995__auto___38406)){
args__32002__auto__.push((arguments[i__31996__auto___38407]));

var G__38408 = (i__31996__auto___38407 + (1));
i__31996__auto___38407 = G__38408;
continue;
} else {
}
break;
...
return quiescent.core.wrapper.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__32003__auto__);
});})(did_warn_38405))
;

quiescent.core.wrapper.cljs$core$IFn$_invoke$arity$variadic = ((function (did_warn_38405){
return (function (child,kvs){
if(cljs.core.truth_(cljs.core.deref.call(null,did_warn_38405))){
} else {
cljs.core.reset_BANG_.call(null,did_warn_38405,true);
...
var temp__4425__auto___38409 = (child.props["key"]);
if(cljs.core.truth_(temp__4425__auto___38409)){
var key_38410 = temp__4425__auto___38409;
(props["key"] = key_38410);
} else {
}
...
quiescent.core.wrapper.cljs$lang$applyTo = ((function (did_warn_38405){
...
return quiescent.core.wrapper.cljs$core$IFn$_invoke$arity$variadic(G__38404,seq38403__$1);
});})(did_warn_38405))
;
/**
 * DEPRECATED. Wrappers do not work properly. Prefer adding lifecycle
